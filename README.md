...
|  aws_session_token | String | AWS session token. This is necessary if the imagery_location input uses IAM credentials such as is in the gbd_customer_data bucket. | False |  
